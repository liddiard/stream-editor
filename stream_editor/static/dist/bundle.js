...
},{"./components/Editor.jsx":161,"./components/Header.jsx":162,"react":155}],161:[function(require,module,exports){
...
var Editor = React.createClass({displayName: "Editor",
  ...
  render: function() {
    var operations = this.state.operations.map(function(operation, index){
      return (
        React.createElement(Operation, {commands: this.state.commands, 
    ...
    var outputs = this.state.outputs.map(function(output, index){
      return (
        React.createElement(Output, {text: this.state.outputs[index], key: index})
      );
    }.bind(this));
    return (
...
},{"./Input.jsx":163,"./Operation.jsx":164,"./Output.jsx":165,"react":155,"superagent":156}],162:[function(require,module,exports){
var React = require('react');
...
var Header = React.createClass({displayName: "Header",
  ...
  render: function() {
    return (
      React.createElement("header", null, 
        React.createElement("p", null, "Text Stream Editor")
      )
    )
  }
...
var Operation = React.createClass({displayName: "Operation",
  ...
  render: function() {
    var options = this.props.commands.map(function(command, index){
      return (
        React.createElement("option", {key: command.name, value: command.name}, 
          command.name
        )
      );
    }.bind(this));
    return (
      React.createElement("div", {className: "operation"}, 
        React.createElement("select", {value: this.props.selected, name: "command", 
                onChange: this.props.onOperationChange.bind(null, this.props.position)}, 
          options
        ), 
        React.createElement("input", {type: "text", name: "args", 
               onChange: this.props.onOperationChange.bind(null, this.props.position), 
