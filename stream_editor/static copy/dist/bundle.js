...
},{"./is-object":163,"./request":165,"./request-base":164,"emitter":1,"reduce":160}],163:[function(require,module,exports){
/**
...
},{"./app.scss":168,"./components/Editor.jsx":169,"./components/Header.jsx":170,"react":159}],168:[function(require,module,exports){
module.exports.tag = require('scssify').createLink("data:text/css;base64,"); module.exports.css = "html{box-sizing:border-box}*,*:before,*:after{box-sizing:inherit}html,body{margin:0;padding:0;font-family:\"Inconsolata\",monospace}html,body,#app{height:100%}body{overflow-x:scroll;background-color:#fafafa}header{position:fixed;width:100%;height:45px;padding:0 0.5em}header h1{font-size:2em;margin:0.2em 0;float:left}header .tagline{font-weight:normal;color:gray;font-size:0.9em;float:left;margin:1.1em 0.9em}main{padding-top:45px;height:100%;display:-webkit-flex;display:flex;-webkit-flex-direction:column;flex-direction:column}textarea,select,input,.dropdown-arrow{outline:none;border:0;border-radius:0;background-color:white}textarea,input{transition:background-color 0.25s}textarea:focus,input:focus{background-color:#fbfdff}.input-container,.output-container{min-width:32%;width:50%}textarea,output{position:absolute;top:0;bottom:0;width:100%;padding:1em;font-size:1.1em;line-height:1.35;font-family:\"Inconsolata\",monospace;resize:none;overflow-y:auto;overflow-x:hidden;border-top:1px solid #d3d3d3;margin-top:0;height:100%}output{border-left:2px solid black;background-color:rgba(255,255,255,0.7);display:block}output pre{font-family:\"Inconsolata\",monospace;margin:0;white-space:pre-wrap}ins{text-decoration:none;background-color:rgba(0,255,0,0.25)}del{text-decoration:none;background-color:rgba(255,0,0,0.25)}.input-container,.output-container{position:relative}.output-container .copy{z-index:100;font-family:\"Helvetica Neue\",Helvetica,Arial,sans-serif;text-transform:uppercase;font-size:0.7em;position:absolute;padding:0.4em 0.8em}.output-container .copy.btn{top:0;right:0;cursor:pointer;color:#0080FF;background-color:white;border:1px solid lightgray}.output-container .copy.btn.zeroclipboard-is-hover{background-color:#eee}.output-container .copy.btn img{height:14px;vertical-align:text-bottom;margin-right:0.25em}.output-container .copy.success-msg{top:1px;right:65px;display:none;color:#0c0;cursor:default;background-color:white;-webkit-transition:opacity 3s ease-in-out;-moz-transition:opacity 3s ease-in-out;-ms-transition:opacity 3s ease-in-out;-o-transition:opacity 3s ease-in-out}.operations{-webkit-flex:0 1 auto;flex:0 1 auto;display:-webkit-flex;display:flex}.operation{min-width:32%;width:50%;display:-webkit-flex;display:flex;border-top:1px solid #d3d3d3;border-bottom:1px solid #d3d3d3;border-left:2px solid black}.operation select{-webkit-appearance:none;-moz-appearance:none}.operation select,.operation input{height:100%}.operation select,.operation input,.operation button{font-family:\"Inconsolata\",monospace;font-size:1.5em;padding:0.25em 0 0.25em 0.35em;margin:0}.operation button.remove-operation{padding:0 0.6em 0 0.3em;background-color:white;border:0;cursor:pointer}.operation button.remove-operation:hover{color:red}.operation .dropdown-arrow{font-size:1.5em;padding:0.15em 0.5em 0 0;border-right:1px solid lightgray;cursor:default}.operation .args{width:100%;position:relative}.operation .args input{width:100%}.operation .error{position:absolute;background-color:rgba(255,0,0,0.5);border-radius:50%;color:white;height:1em;width:1em;text-align:center;right:0;top:0;font-size:1.2em;margin:0.45em 0.2em;cursor:default}.operation .error:hover{background-color:rgba(255,0,0,0.7)}.operation .error:hover:before{border:solid;border-color:#333 transparent;border-width:6px 6px 0 6px;bottom:1em;right:0.2em;content:\"\";position:absolute;z-index:99}.operation .error:hover:after{background:rgba(0,0,0,0.8);border-radius:3px;content:attr(data-tooltip);bottom:1.95em;right:0;padding:0.5em 0.75em;position:absolute;z-index:100;font-family:\"Helvetica Neue\",Helvetica,Arial,sans-serif;font-size:0.8rem;width:320px;text-align:left}.editor-options{position:fixed;top:0;right:0;margin:0.45rem 0.5rem;z-index:200;line-height:2}.editor-options label{margin-right:0.75em;font-weight:bold;white-space:nowrap}.editor-options a{color:gray;font-size:0.9em;margin-left:0.25em;white-space:nowrap}.editor-options a:hover{color:black}.editor-options.open-btn{margin-top:-1.3em;cursor:pointer;display:none;text-transform:uppercase;font-family:\"Helvetica Neue\",Helvetica,Arial,sans-serif;font-size:0.8em;z-index:0}.editor-options.open-btn .label{vertical-align:text-bottom}.editor-options.open-btn .gear{font-size:3em;margin-left:0.15em}.editor-options .option{display:inline-block}.editor-options .command-reference{margin-right:0.75em;position:relative;display:inline-block}.editor-options .command-reference:hover{background-color:rgba(0,0,0,0.1)}.editor-options .command-reference:hover .contents{display:block}.editor-options .command-reference .dropdown{cursor:default;font-weight:bold;border:1px solid lightgray;padding:0 0.6em;vertical-align:top;line-height:1.8}.editor-options .command-reference .contents{color:white;position:absolute;background-color:rgba(0,0,0,0.8);z-index:300;color:white;padding:0.5em 1em;font-size:0.9em;width:420px;display:none;line-height:1}.editor-options .command-reference .contents .cmd{margin:0.4em 0}.editor-options .command-reference .contents .cmd a{color:#B5DAFF;margin-left:0.5em;font-size:1em}.editor-options .command-reference .contents .cmd .name{font-weight:bold}.editor-options .command-reference .contents .cmd .description{margin:0.2em}.io{-webkit-flex:1 1 auto;flex:1 1 auto;display:-webkit-flex;display:flex;height:0}#logo{font-family:\"Inconsolata\",monospace;font-size:1.5em;float:left;margin:0.2em 0.4em 0.2em 0;color:lightgray;background-color:#222;position:relative;padding:0.15em 1.2em 0.15em 0.25em;border-radius:0.2em;border:1px solid gray;cursor:default}#logo img{width:22px;position:absolute;right:0.14em;top:0.24em}@media (max-width: 1180px){header .tagline{display:none}}@media (max-width: 960px){.input-container,.output-container,.operation{min-width:45%}}@media (max-width: 820px){.editor-options.editor-options-options{background-color:white;padding:0.5em 0.75em;box-shadow:2px 2px;border:1px solid gray;margin:0 2.5em 0 0}.editor-options.hidden-mobile{display:none}.editor-options.open-btn{display:block}}@media (max-width: 640px){.input-container,.output-container,.operation{min-width:60%}}@media (max-width: 480px){.input-container,.output-container,.operation{min-width:90%}.editor-options .command-reference .contents{width:90vw}}\n";
},{"scssify":161}],169:[function(require,module,exports){
...
var Editor = React.createClass({displayName: "Editor",
  ...
  render: function() {
    var operations = this.state.operations.map(function(operation, index){
      return (
        React.createElement(Operation, {cmds: this.state.cmds, 
    ...
    var outputs = this.state.outputs.map(function(output, index){
      ...
      return (
        React.createElement(Output, {text: this.state.outputs[index], prevText: prevText, 
    ...
    var commandsInfo = this.state.cmds.map(function(cmd, index){
      return (
        React.createElement("div", {className: "cmd", key: index}, 
          React.createElement("span", {className: "name"}, cmd.name, " "), 
          React.createElement("span", {className: "description"}, cmd.description), 
          React.createElement("a", {target: "_blank", href: cmd.docs}, "docs"), 
          React.createElement("a", {target: "_blank", href: cmd.examples}, "examples")
        )
      );
    });
    ...
    return (
      React.createElement("main", null, 
        React.createElement("div", {className: editorOptionsClassName}, 
          React.createElement("div", {className: "command-reference"}, 
          ...
          React.createElement("div", {className: "option"}, 
            React.createElement("input", {type: "checkbox", id: "show-diff", checked: this.state.showDiff, 
                   onChange: this.handleShowDiffChange}), 
            React.createElement("label", {htmlFor: "show-diff"}, "Show diff")
          ), 
          React.createElement("div", {className: "option"}, 
            React.createElement("input", {type: "checkbox", id: "sync-scrolling", checked: this.state.syncScrolling, 
                   onChange: this.handleSyncScrollingChange}), 
            React.createElement("label", {htmlFor: "sync-scrolling"}, "Sync scrolling")
          ), 
          React.createElement("a", {href: "https://github.com/liddiard/stream-editor/issues/", 
             onClick: this.handleFeedbackClick}, 
            "Give feedback"
          )
        ), 
        React.createElement("div", {className: "editor-options open-btn", 
             onClick: this.handleEditorOptionsDropdownVisibleChange}, 
          React.createElement("span", {className: "label"}, "Settings"), 
          React.createElement("span", {className: "gear"}, "⚙")
        ), 
        React.createElement("div", {className: "io"}, 
          React.createElement(Input, {text: this.state.input, onInputChange: this.handleInputChange}), 
          outputs
        ), 
...
},{"../utils.js":174,"./Input.jsx":171,"./Operation.jsx":172,"./Output.jsx":173,"react":159,"superagent":162}],170:[function(require,module,exports){
var React = require('react');
    ...
    return (
      React.createElement("header", null, 
        React.createElement("div", {id: "logo"}, 
          ">", React.createElement("img", {src: "/static/img/pencil-icon.svg"})
        ), 
        React.createElement("h1", null, "Stream Editor"), 
        React.createElement("h2", {className: "tagline"}, 
...
var Operation = React.createClass({displayName: "Operation",
  ...
  render: function() {
    ...
    var options = this.props.cmds.map(function(cmd, index){
      return (
        React.createElement("option", {key: cmd.name, value: cmd.name}, 
          cmd.name
        )
      );
    }.bind(this));
    ...
    if (this.props.canRemoveOperation() &&
      ...
      removeButton = (
        React.createElement("button", {className: "remove-operation", 
    ...
    if (this.props.operation.error.length) {
      error = (
        React.createElement("div", {className: "error", "data-tooltip": this.props.operation.error}, 
          "!"
        )
      );
    }
    ...
    return (
      React.createElement("div", {className: "operation"}, 
        React.createElement("select", {name: "cmd", value: this.props.operation.cmd, 
        ...
        React.createElement("div", {className: "args"}, 
          React.createElement("input", {type: "text", name: "args", value: this.props.operation.args, 
...
},{"../utils.js":174,"react":159}],173:[function(require,module,exports){
var React = require('react');
...
var Output = React.createClass({displayName: "Output",
  ...
  render: function() {
    ...
    if (this.props.showDiff) {
      ...
      text = React.createElement("pre", {dangerouslySetInnerHTML: createMarkup()});
    }
    else {
      text = React.createElement("pre", null, this.props.text);
    }
    return (
      React.createElement("div", {className: "output-container"}, 
        React.createElement("div", {className: "copy success-msg"}, 
          "✓ Copied to clipboard"
        ), 
        React.createElement(ReactZeroClipboard, {text: this.props.text, onAfterCopy: utils.displayCopySuccess}, 
          React.createElement("div", {className: "copy btn"}, 
            React.createElement("img", {src: "/static/img/clipboard-icon.svg"}), 
            "Copy"
          )
        ), 
...
},{"../utils.js":174,"react":159,"react-zeroclipboard":3,"text-diff":166}],174:[function(require,module,exports){
module.exports = {
